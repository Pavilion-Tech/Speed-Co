...
class PAboutUsScreen extends StatelessWidget {
  ...
  builder: (context, state) {
    return Scaffold(
      appBar: pDefaultAppBar(context: context,title: tr('about_us'),isMenu: true),
        ...
        child: Padding(
          ...
          child:  ConditionalBuilder(
            ...
            builder: (context)=> Html(
                data:myLocale == 'en'
                    ? ProviderMenuCubit.get(context).staticPageModel!.data!.aboutUsEn
                    : ProviderMenuCubit.get(context).staticPageModel!.data!.aboutUsAr
            ),
          ),
        ),
      ),
